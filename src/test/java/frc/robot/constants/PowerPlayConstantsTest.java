...
/**
 * Test the PowerPlay field layout.
 */
public class PowerPlayConstantsTest {

    @Test
    public void testFieldDimensions() {
        // check length of field
        assertEquals(54.0, Units.metersToFeet(PowerPlayConstants.fieldLength), 0.001);
        // check width of field
        assertEquals(27.0, Units.metersToFeet(PowerPlayConstants.fieldWidth), 0.001);
    }

    @Test
    public void testAprilTag3() {
        // get April Tag with ID 3
        Optional<Pose3d> opose3d = PowerPlayConstants.aprilTagFieldLayout.getTagPose(3);
    ...
    public void testAprilTag7() {
        ...
        Optional<Pose3d> opose3d = PowerPlayConstants.aprilTagFieldLayout.getTagPose(7);
