...
public class RobotContainer {
  ...
  public void autoChooserUpdate() {
    ...
    if (m_drive != null && m_elevator != null && m_arm != null && m_intake != null) {
      ...
      m_autoCommand.addOption("Grid 4 Engage (no mobility)", new DepositThenPath("Grid 4 Engage No Mobility", autoDepositPos, m_drive, m_elevator, m_arm, m_intake).andThen(new BalanceCommand(m_drive)));
      ...
      m_autoCommand.addOption("NO DEPOSIT Grid 4 Engage (no mobility)",
        new PathPlannerCommand("Grid 4 Engage No Mobility", 0, m_drive, true).andThen(
        new PathPlannerCommand("Grid 4 Engage No Mobility", 1, m_drive, true)).andThen(
        new BalanceCommand(m_drive))
      );
