...
public class Blinkin {
  ...
  enum Colors{
    ...
    COLOR_GRADIANT_ONE_TWO(0.41),
    BPM_ONE_TWO(0.43),
    END_END_ONE_TWO(0.45),
    END_END(0.47),
    ONE_TWO_NO_BLENDING(0.49),
    TWINKLES_ONE_TWO(0.51),
    COLOR_WAVES_ONE_TWO(0.53),
    SINELON_ONE_TWO(0.55),
    HOT_PINK(0.57),
    DARK_RED(0.59),
    RED(0.61),
    ORANGE(0.65),
