...
public class DriveConstants {
    ...
    // NEW 2023 BOT
    // TODO: ADD NEW ENUM FOR THIS
    public final int kDriveFrontLeft = 20;
    public final int kSteerFrontLeft = 15;
    public final int kEncoderFrontLeft = 40;
    ...
    public final int kDriveFrontRight = 33; 
    public final int kSteerFrontRight = 30;
    public final int kEncoderFrontRight = 41; 
    ...
    public final int kSteerBackLeft = 18;
    public final int kEncoderBackLeft = 42; 
    ...
    public final int kEncoderBackRight = 43; 
