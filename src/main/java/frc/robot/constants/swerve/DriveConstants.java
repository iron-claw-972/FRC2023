...
public abstract class DriveConstants {
  ...
  public static double kDriveKSFrontLeft = 0.5384956475063728;
  public static double kDriveKVFrontLeft = 4.571363055570819;
  public static double kDrivePFrontLeft = 2;
  public static double kDriveIFrontLeft = 0;
  public static double kDriveDFrontLeft = 0;
  public static double kSteerKSFrontLeft = 0.6439354174645302;
  public static double kSteerKVFrontLeft = 0.3633117439738411;
  ...
  public static double kDriveKSFrontRight = 0.6593996976648525;
  public static double kDriveKVFrontRight = 4.387856547350842;
  public static double kDrivePFrontRight = 2;
  public static double kDriveIFrontRight = 0;
  public static double kDriveDFrontRight = 0;
  public static double kSteerKSFrontRight = 0.7243860076815182;
  public static double kSteerKVFrontRight = 0.3681858814665129;
  ...
  public static double kDriveKSBackLeft = 0.3912866106788668;
  public static double kDriveKVBackLeft = 4.829182862968741;
  public static double kDrivePBackLeft = 2;
  public static double kDriveIBackLeft = 0;
  public static double kDriveDBackLeft = 0;
  public static double kSteerKSBackLeft = 0.7293110997341092;
  public static double kSteerKVBackLeft = 0.3714246813547924;
  ...
  public static double kDriveKSBackRight = 0.5380192463582368;
  public static double kDriveKVBackRight = 4.592220363573887;
  public static double kDrivePBackRight = 2.2;
  public static double kDriveIBackRight = 0;
  public static double kDriveDBackRight = 0;
  public static double kSteerKSBackRight = 0.6696247231536104;
  public static double kSteerKVBackRight = 0.3725996876653879;
  ...
  static {
    if (Constants.kRobotType == RobotType.TEST) {
      ...
      // CAN
      kDriveMotorCAN = "rio";
    } else if (Constants.kRobotType == RobotType.COMP) {
      kWheelRadius = Units.inchesToMeters(2);
      ...
      kMaxSpeed = FalconConstants.kMaxRpm / 60.0 / kDriveGearRatio * kWheelRadius * 2 * Math.PI;
      
      kMaxAngularSpeed = FalconConstants.kMaxRpm / 60.0 / kSteerGearRatio * 2 * Math.PI; // 8.3 rot/s
      kMaxAngularAccel = 8 * 2 * Math.PI; // 8 rotations per second per second
      
      kPigeon = 0;
      
      kStartingHeadingDegrees = 0;
      
      kDriveFrontLeft = 20;
      kSteerFrontLeft = 15;
      kEncoderFrontLeft = 40;
      kSteerOffsetFrontLeft = 0.058291152119637;//-3.060285486280918+Math.PI;
      kDriveKSFrontLeft = 0.5671488314798404;
      kDriveKVFrontLeft = 4.546193650654074;
      kDrivePFrontLeft = 2;
      kDriveIFrontLeft = 0;
      kDriveDFrontLeft = 0;
      kSteerKSFrontLeft = 0.6996691434004014;
      kSteerKVFrontLeft = 0.3632874182531057;
      kSteerPFrontLeft = 14;
      kSteerIFrontLeft = 0;
      kSteerDFrontLeft = 0;
      ...
      kSteerOffsetFrontRight = -2.994324445724487;//-3.001994334161282;
      kDriveKSFrontRight = 0.6880086692853459;
      kDriveKVFrontRight = 4.336917320413962;
      kDrivePFrontRight = 2;
      kDriveIFrontRight = 0;
      kDriveDFrontRight = 0;
      kSteerKSFrontRight = 0.6429664500296258;
      kSteerKVFrontRight = 0.3645372486658138;
      kSteerPFrontRight = 14;
      kSteerIFrontRight = 0;
      kSteerDFrontRight = 0;
      ...
      kSteerBackLeft = 18;
      kEncoderBackLeft = 42; 
      kSteerOffsetBackLeft = -2.540267050266266;//0.650406539440155+Math.PI;
      kDriveKSBackLeft = 0.4549680357672717;
      kDriveKVBackLeft = 4.936626078325219;
      kDrivePBackLeft = 2;
      kDriveIBackLeft = 0;
      kDriveDBackLeft = 0;
      kSteerKSBackLeft = 0.6685253827543534;
      kSteerKVBackLeft = 0.3703123041002871;
      kSteerPBackLeft = 14;
      kSteerIBackLeft = 0;
      kSteerDBackLeft = 0;
      ...
      kSteerOffsetBackRight = 2.626169800758362;//2.771897681057453;
      kDriveKSBackRight = 0.46914605136974696;
      kDriveKVBackRight = 4.625248274107886;
      kDrivePBackRight = 2.2;
      kDriveIBackRight = 0;
      kDriveDBackRight = 0;
      kSteerKSBackRight = 0.7151324607226578;
      kSteerKVBackRight = 0.3731499810181726;
      kSteerPBackRight = 14;
      kSteerIBackRight = 0;
      kSteerDBackRight = 0;
      ...
      // CAN
      kDriveMotorCAN = "CANivore";
      kSteerMotorCAN = "CANivore";
      kPigeonCAN = "CANivore";
      kEncoderCAN = "CANivore";
    }
  }
